...
function square(arr) {
    ...
    //     number * number
    // )
    let newarr = arr.map((number,index)=> number * number);
    return newarr;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    // write your code here
    // let newarr = arr.map((number,index)=> number.firstName + number.lastName);
    // return newarr;
    return arr.map((number,index)=> `${number.firstName} ${number.lastName}`);
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    ...
    return arr.map((object,index) => {
        let sum = 0;
        for (let i = 0 ; i < object.gradsList.length ; i++){
            sum += object.gradsList[i];
        }
        let avg = sum / object.gradsList.length;
        object.avg = avg;
        return object;
    });
...
function studentsResult(arr) {
    ...
    // return arr.map((object,index)=> {
    //     if (object.avg < 50 ){
    //        return object.result = 'Faild';
    //     }else if (object.avg >= 50) {
    //        return object.result = 'Passed';
    //     }
